...
# This script plots weekly tail lengths of New York mice and 
# Brazil mice across environments (i.e., common garden experiment #2).
# This script generates Figure 4 in Ballinger_AmNat_2021.
...
FemaleTL <-
  ggplot(data=FemaleData, aes(x=Age_weeks, y=Tail_Length_mm, color = PopEnv, fill = PopEnv, linetype = PopEnv, color = PopEnv)) +
...
ggsave("results/figures/Weekly_Tails.pdf", height = 5.5, width = 3.75)
