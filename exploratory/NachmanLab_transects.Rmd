...
Determine if house mice show Bergmann's rule and Allen's rule using specimens collected by the Nachman Lab. House mice have been collected across a broad latitudinal distribution in the Americas, as part of a large lab project - ["Environmental adaptation in introduced populations of house mice, Mus musculus, across the Americas"](http://arctos.database.museum/project/10001341).
...
There is strong and clear evidence for Bergmann's rule in wild-caught "Nachman Lab" house mice across the Americas


### Allen's rule (using tail length)
```{r Allen_TL_RawData, message=FALSE, echo=FALSE, fig.show='hide'}
...
```{r TailResiduals, message = FALSE, echo=FALSE, fig.show='hide'}
...
```{r all_data_bodylength, message=FALSE, echo=FALSE, fig.show='hide'}
#### check data to ensure they are normally distributed ####
...
```{r BW~bodylength, message=FALSE, echo = FALSE, fig.show='hide'}
