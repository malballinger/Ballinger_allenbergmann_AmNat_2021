...
output:
  ...
  pdf_document:
    keep_tex: true
title: |
  | \LARGE{The contribution of genetic and environmental effects to Bergmann’s rule and Allen’s rule in house mice}
subtitle: |
  | \vspace{10mm}\large{Mallory A. Ballinger and Michael W. Nachman}
...
\noindent__Keywords:__ body size, extremity length, adaptive plasticity, *Mus*
...
\noindent_Differences in body mass and extremity length persist in a common environment_
...
**Figure 2. Body mass and extremity length differences among populations persist over generations in a common lab environment.**
Differences in body mass (A), tail length (B), and ear length (C) between New York mice (blue) and Brazil mice (gold) across generations. Tail length and ear length are plotted relative to body mass for each individual. Population-level data are depicted as boxplots overlayed on density plots, with boxplot vertical lines denoting 1.5x the inerquartile range. Individuals are represented as individual points. Results from linear models are presented in the upper right corner of each panel (\*_P_<0.05; Figure S1). Sample sizes: (A) *n* = `r BW_Generation_n`; (B) *n* = `r TL_Generation_n`; (C) *n* = `r EL_Generation_n`.
...
Individuals are represented as individual points (*n* = `r BW_PD_n`), and boxplots indicate the 25th, median, and 75th quartiles. Results from linear mixed models are presented in the upper right corner (*_P_<0.05; Figure S2). The same individuals depicted here are also depicted in Figure 3.
...
Tail length (A) and ear length (B) are plotted relative to body mass for each individual. Individuals are represented as individual points (tail length: *n* = `r TL_PD_n`; ear length: *n* = `r EL_PD_n`), and boxplots indicate the 25th, median, and 75th quartiles. Both sexes were combined for simplicity. Results from linear mixed models are presented in the upper right corner (\*_P_<0.05; Figure S2). The same individuals depicted here are also depicted in Figure 5.
...
**Figure S2. Effect sizes for common garden experiment two, investigating the fixed effects of sex, population, and environment on body mass, tail length, ear length, and body mass index.**
...
**Figure S3. No evolved differences or plasticity in body mass index (BMI) among New York mice and Brazil mice.**
Individuals are represented as individual points (*n* = `r nrow(PostDissectionMetaData)`). The same individuals depicted here are also depicted in Figure 4.
